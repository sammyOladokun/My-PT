...
const StatCard = ({
  ...
  <div
    className={`card border border-border/35 rounded-xl p-4 w-full h-full bg-card/40 backdrop-blur-md transition-transform duration-200 hover:scale-105 supports-[backdrop-filter]:bg-card/30 ${className}`}
  >
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
        <div className="relative flex flex-col p-8 overflow-hidden transition-all duration-300 border shadow-sm group bg-card/35 backdrop-blur-md text-card-foreground rounded-xl border-border/35 hover:border-border/60 hover:shadow-md supports-[backdrop-filter]:bg-card/25">
      ...
      {/* GitHub Graphs */}
      <div className="flex items-center justify-center w-full p-4 mb-8 border border-border/35 rounded-xl bg-card/20 backdrop-blur-md supports-[backdrop-filter]:bg-card/15">
        <GitHubGraphs />
      </div>
